...
class PS4JoystickController(JoystickController):
    ...
    def run_threaded(self, img_arr=None, mode=None, recording=None):  # ! 編集済み
        """
        :param img_arr: current camera image or None
        :param mode: default user/mode
        :param recording: default recording mode
    ...
    def init_trigger_maps(self):  # ! 編集済み
        """ボタンから関数へのマッピング"""
        self.button_down_trigger_map = {
            "L1": self.toggle_mode,
            "R1": self.toggle_manual_recording,
        }
        self.axis_trigger_map = {
            "left_stick_vert": self.set_throttle,
            "left_trigger_axis": self.set_steering,
            "right_stick_horz": self.set_brake,
        }
